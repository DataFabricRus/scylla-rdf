...
class ScyllaRDFEvaluationStatistics(private val dao: ICardinalityDAO, private val coder: CoderFacade)
    ...
    private class ScyllaRDFCardinalityCalculator(private val dao: ICardinalityDAO, private val coder: CoderFacade)
